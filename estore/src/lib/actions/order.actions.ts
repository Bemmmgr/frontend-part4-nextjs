...
// 095 - get sales data & order summary
export async function getOrderSummary() {
  ...
  // get monthly sales - write sql query
  /*
  [
    { month: "07/26", totalSales: Decimal("500.00") },
    { month: "08/26", totalSales: Decimal("900.00") },
  ] */
...
// 099 - admin orders action - get all orders
...
//101 - update the order to paid by COD(cash on deilvery)
